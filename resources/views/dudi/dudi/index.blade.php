    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <h5>Data Dudi</h5>
                <div>
                    <a href="{{route('dudi.create')}}" class="btn btn-primary btn-sm" id="btnAdd"><i class="bi bi-plus-square"></i> Tambah</a>
                    <button class="btn btn-success btn-sm" id="btnUploadExcel"><i class="bi bi-upload"></i> Upload</button>
                    <a class="btn btn-danger btn-sm" href="{{ route('dudi.downloadExcel') }}"><i class="bi bi-download"></i> Download</a>
    ...
    <script>
        $(function() {
            ...
            $('#uploadExcelForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('dudi.uploadExcel') }}', // Route untuk handle upload
                    method: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
