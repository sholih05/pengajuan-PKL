                    ...
                    <div class="step" id="step-1">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nis" name="nis"
                                value="{{ old('nis') }}" required maxlength="10" minlength="10">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nisn" name="nisn"
                                value="{{ old('nisn') }}" required maxlength="10" minlength="10">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir"
                                value="{{ old('tempat_lahir') }}" required maxlength="20">
                        ...
                        <div class="mb-3">
                            ...
                            <img id="preview" src="" alt="Preview Foto"
                                style="display: none; margin-top: 10px; max-width: 200px; height: auto;">
                        </div>
                    ...
                    <div class="step d-none" id="step-2">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="no_kontak" name="no_kontak"
                                value="{{ old('no_kontak') }}" required maxlength="14">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                value="{{ old('email') }}" required maxlength="35">
                            <div class="invalid-feedback">Email wajib diisi dan maksimal 35 karakter.</div>
                        </div>

                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <textarea class="form-control" id="alamat" name="alamat" rows="3" required maxlength="225">{{ old('alamat') }}</textarea>
                    ...
                    <div class="step d-none" id="step-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_wali" name="nama_wali"
                                value="{{ old('nama_wali') }}" required maxlength="35">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="alamat_wali" name="alamat_wali" rows="3" required maxlength="225">{{ old('alamat_wali') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="no_kontak_wali" name="no_kontak_wali"
                                value="{{ old('no_kontak_wali') }}" required maxlength="14">
